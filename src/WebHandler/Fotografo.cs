namespace Automation.WebScraper
{
  public partial class Manager
  {
    public void Fotografo()
    {
      ...
      var balde_nome = this.configuration.recurso[this.configuration.contador_de_baldes].Split('>').Last();
      var filename = $"./tmp/{this.agora.ToString("yyyyMMdd_HHmmss")}_{balde_nome}.png";
